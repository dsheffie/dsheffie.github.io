...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'rv64_core.data';
      var REMOTE_PACKAGE_BASE = 'rv64_core.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_rv64_core.data');

      };
      Module['addRunDependency']('datafile_rv64_core.data');
